...
The simplest way to do this is to allocate an array between the two arrays, so that the relative addresses will not be subject to field reordering, though this limits the smallest possible offset to the size of the array header.
