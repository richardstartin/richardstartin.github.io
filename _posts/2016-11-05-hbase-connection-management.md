---
ID: 23
post_title: HBase Connection Management
author: Richard Startin
post_excerpt: ""
layout: post
permalink: >
  http://richardstartin.uk/hbase-connection-management/
published: true
post_date: 2016-11-05 10:39:02
---
...
In order to get the user proxying working, the UserGroupInformation for the web application service principal itself is required (see <a href="http://richardstartin.uk/perpetual-kerberos-login-in-hadoop/">here</a>), and you need to have successfully authenticated your user (I used SPNego to do this). The Hadoop class UserProvider is then used to create a proxy user. Your web application service principal also needs to be configured as a proxying user in core-site.xml, which you can manage via tools like Ambari.
