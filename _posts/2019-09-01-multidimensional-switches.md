...
I was reading my Twitter feed in the bath this morning when I noticed Brian Goetz talking about multidimensional switch expressions.
This would be an amazing feature for the Java language. I wonder, if the feature were to arrive in the quickly improving language, which data structure would the engineers use to implement it?
That is, what will happen when your execution path hits a multi-dimensional switch expression?
