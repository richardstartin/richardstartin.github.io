...
### Size `HashMap`s whenever possible
...
|---|--------------------------------------------------------|----|-------|-------|-----------|-------------------|------|------------------|-----------|
|11 |AsciiString.stringFromBytes                             |avgt|1      |5      |18.355847  |0.674115           |ns/op |UTF-8             |4          |
|8  |AsciiString.stringFromBytes                             |avgt|1      |5      |51.693575  |1.610212           |ns/op |UTF-8             |4          |
|11 |AsciiString.stringFromBytes:·gc.alloc.rate.norm         |avgt|1      |5      |48.000008  |0.000001           |B/op  |UTF-8             |4          |
|8  |AsciiString.stringFromBytes:·gc.alloc.rate.norm         |avgt|1      |5      |88.000023  |0.000003           |B/op  |UTF-8             |4          |
|11 |AsciiString.stringFromBytes                             |avgt|1      |5      |20.827067  |3.695586           |ns/op |UTF-8             |20         |
|8  |AsciiString.stringFromBytes                             |avgt|1      |5      |60.232549  |1.767569           |ns/op |UTF-8             |20         |
|11 |AsciiString.stringFromBytes:·gc.alloc.rate.norm         |avgt|1      |5      |64.000009  |0.000002           |B/op  |UTF-8             |20         |
|8  |AsciiString.stringFromBytes:·gc.alloc.rate.norm         |avgt|1      |5      |120.000026 |0.000004           |B/op  |UTF-8             |20         |
|11 |AsciiString.stringFromBytes                             |avgt|1      |5      |34.451863  |9.095702           |ns/op |UTF-8             |200        |
|8  |AsciiString.stringFromBytes                             |avgt|1      |5      |159.427489 |8.422851           |ns/op |UTF-8             |200        |
|11 |AsciiString.stringFromBytes:·gc.alloc.rate.norm         |avgt|1      |5      |240.000014 |0.000004           |B/op  |UTF-8             |200        |
|8  |AsciiString.stringFromBytes:·gc.alloc.rate.norm         |avgt|1      |5      |480.000070 |0.000011           |B/op  |UTF-8             |200        |
|11 |AsciiString.stringFromBytes                             |avgt|1      |5      |285.590238 |75.077635          |ns/op |UTF-8             |2000       |
|8  |AsciiString.stringFromBytes                             |avgt|1      |5      |1350.229058|69.483579          |ns/op |UTF-8             |2000       |
|11 |AsciiString.stringFromBytes:·gc.alloc.rate.norm         |avgt|1      |5      |2040.000118|0.000030           |B/op  |UTF-8             |2000       |
|8  |AsciiString.stringFromBytes:·gc.alloc.rate.norm         |avgt|1      |5      |4080.000601|0.000117           |B/op  |UTF-8             |2000       |
...
|JDK|Benchmark                                               |Mode|Threads|Samples|Score      |Score Error (99.9%)|Unit  |Param: charsetName|Param: size|
|---|--------------------------------------------------------|----|-------|-------|-----------|-------------------|------|------------------|-----------|
|11 |AsciiBytes.bytesFromString                              |avgt|1      |5      |13.835438  |0.661028           |ns/op |UTF-8             |4          |
|8  |AsciiBytes.bytesFromString                              |avgt|1      |5      |62.958213  |1.832734           |ns/op |UTF-8             |4          |
|11 |AsciiBytes.bytesFromString:·gc.alloc.rate.norm          |avgt|1      |5      |24.000006  |0.000001           |B/op  |UTF-8             |4          |
|8  |AsciiBytes.bytesFromString:·gc.alloc.rate.norm          |avgt|1      |5      |160.000028 |0.000004           |B/op  |UTF-8             |4          |
|11 |AsciiBytes.bytesFromString                              |avgt|1      |5      |17.457885  |2.175969           |ns/op |UTF-8             |20         |
|8  |AsciiBytes.bytesFromString                              |avgt|1      |5      |75.760063  |3.000610           |ns/op |UTF-8             |20         |
|11 |AsciiBytes.bytesFromString:·gc.alloc.rate.norm          |avgt|1      |5      |40.000007  |0.000002           |B/op  |UTF-8             |20         |
|8  |AsciiBytes.bytesFromString:·gc.alloc.rate.norm          |avgt|1      |5      |224.000033 |0.000004           |B/op  |UTF-8             |20         |
|11 |AsciiBytes.bytesFromString                              |avgt|1      |5      |30.758900  |8.336043           |ns/op |UTF-8             |200        |
|8  |AsciiBytes.bytesFromString                              |avgt|1      |5      |227.269922 |18.536450          |ns/op |UTF-8             |200        |
|11 |AsciiBytes.bytesFromString:·gc.alloc.rate.norm          |avgt|1      |5      |216.000013 |0.000003           |B/op  |UTF-8             |200        |
|8  |AsciiBytes.bytesFromString:·gc.alloc.rate.norm          |avgt|1      |5      |936.000100 |0.000014           |B/op  |UTF-8             |200        |
|11 |AsciiBytes.bytesFromString                              |avgt|1      |5      |280.886995 |61.136388          |ns/op |UTF-8             |2000       |
|8  |AsciiBytes.bytesFromString                              |avgt|1      |5      |2138.703149|203.825640         |ns/op |UTF-8             |2000       |
|11 |AsciiBytes.bytesFromString:·gc.alloc.rate.norm          |avgt|1      |5      |2016.000116|0.000024           |B/op  |UTF-8             |2000       |
|8  |AsciiBytes.bytesFromString:·gc.alloc.rate.norm          |avgt|1      |5      |8136.000937|0.000113           |B/op  |UTF-8             |2000       |

</div>

These operations are so fundamental that it's impossible to escape them. Upgrade!
