...
When the load is for the same data as a recent store, this is called a _write after read hazard_; if such a hazard is detected, the load is reissued, which costs a few cycles.
