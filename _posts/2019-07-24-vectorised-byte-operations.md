...
I was encouraged to find out recently that many operations on `byte[]` can now be vectorised by C2 from JDK13. 
...
This is particularly relevant to this logical 8-bit right shifts, because they don't exist in AVX2, and need to be composed from several operations as can be seen in the perfasm output earlier in the post.
