...
For reference, here's the 32 bit version written in Java, adapted from [lz4-java](https://github.com/lz4-lz4-java), with the bullet points above labeled as the "main loop".
